...
namespace MultiSoketHub
{
    public class SocketHub
    {
        ...
        public event EventHandler<SocketHubEventArgs> MessageReceived;
        public event EventHandler<SocketHubEventArgs> ClientConnected;
        public SocketHub(int numberofsockets, string peerEndPoint, int port)
        {
        ...
        public void StartServer()
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    SocketHubEventArgs eventArgs = new SocketHubEventArgs();
            ...
            try
            {
                ...
                if (bytesRead > 0)
                {
                    ...
                    if (isMasked)
                    {
                        ...
                        SocketHubEventArgs receivedEventArgs = new SocketHubEventArgs();
    ...
    public class SocketHubEventArgs : EventArgs
    {
